// left sidebar nav functionality changed from 992 to 1200 px by Anupam Khosla
    ...
    init : function(options) {
      ...
      $(this).each(function(){
        ...
        if (menu.hasClass('fixed')) {
            if (window.innerWidth > 1200) { //992 change to 1200 by Anupam Khosla on 12 july 2017 -- customized
        ...
        if (options.closeOnClick === true) {
          menu.on("click.itemclick", "a:not(.collapsible-header)", function(){
            if (!(window.innerWidth > 1200 && menu.hasClass('fixed'))){ //992 change to 1200 by Anupam Khosla on 12 july 2017 -- customized
              removeMenu();
            }
          });
        }
